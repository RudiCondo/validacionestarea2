...
<div class="wrapper">
  ...
  <!-- Preloader esto es lo que te sale mientras te carga la pagina -->
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    <!-- Left navbar links navegador de la izquierda(barra de menu de arriba) -->
    <!--<ul class="navbar-nav">
      <li class="nav-item">
      ...
      <!--<li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <a href="#" class="dropdown-item">-->
            <!-- Message Start -->
            <!--<div class="media">
              <img src="/assest/dist/img/user3-128x128.jpg" alt="User Avatar" class="img-size-50 img-circle mr-3">
              <div class="media-body">
                <h3 class="dropdown-item-title">
                  Nora Silvester
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="<?php echo base_url(); ?>/assest/dist/img/logo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="<?php echo base_url();?>/assest/dist/img/user.png" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
      ...
      <!-- SidebarSearch Form este es el buscador -->
